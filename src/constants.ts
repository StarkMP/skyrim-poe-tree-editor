...
export const NODE_RADIUS_MEDIUM = 36 as const;
export const NODE_RADIUS_LARGE = 48 as const;
export const NODE_RADIUS_EXTRALARGE = 60 as const;
...
export const ORBIT_MAX_POINTS = 360 as const;
...
export const WEB_MAX_SPOKES = 360 as const;
...
export const WEB_MAX_CONCENTRIC_CIRCLES = 50 as const;
